...
class com_sermondistributorInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			$sermon->field_mappings = '{"common": {"core_content_item_id": "id","core_title": "name","core_state": "published","core_alias": "alias","core_created_time": "created","core_modified_time": "modified","core_body": "description","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "metadata","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "metakey","core_metadesc": "metadesc","core_catid": "catid","core_xreference": "null","asset_id": "asset_id"},"special": {"name":"name","preacher":"preacher","series":"series","short_description":"short_description","link_type":"link_type","source":"source","auto_sermons":"auto_sermons","description":"description","icon":"icon","tags":"tags","build":"build","alias":"alias","local_files":"local_files","scripture":"scripture","manual_files":"manual_files","not_required":"not_required","url":"url"}}';
