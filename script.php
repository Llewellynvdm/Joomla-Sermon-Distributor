...
class com_sermondistributorInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			// Create the sermon catagory content type object.
		...
		if ($type == 'update')
		{
			...
			// Check if sermon catagory type is already in content_type DB.
