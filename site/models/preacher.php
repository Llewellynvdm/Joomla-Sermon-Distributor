...
class SermondistributorModelPreacher extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [Interpretation 1153] Get from #__sermondistributor_series as c
		$query->select($db->quoteName(
		...
		// [Interpretation 1153] Get from #__sermondistributor_preacher as d
		$query->select($db->quoteName(
	...
	*/
	public function getPreacher()
	{
		...
		// [Interpretation 1153] Get from #__sermondistributor_preacher as a
		$query->select($db->quoteName(
	...
	*/
	public function getNumberDownloads()
	{
		...
		// [Interpretation 1886] Get the global params
		$globalParams = JComponentHelper::getParams('com_sermondistributor', true);
		// [Interpretation 2294] Get a db connection.
		$db = JFactory::getDbo();
		...
		// [Interpretation 1153] Get from #__sermondistributor_statistic as a
		$query->select($db->quoteName(
		...
		// [Interpretation 1891] Reset the query using our newly populated query object.
		$db->setQuery($query);
		...
		// [Interpretation 1900] return items
		return $items;
	}
