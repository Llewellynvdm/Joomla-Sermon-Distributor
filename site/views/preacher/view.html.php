...
class SermondistributorViewPreacher extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		// [3492] load the meta description
		...
		// [3501] load the key words if set
