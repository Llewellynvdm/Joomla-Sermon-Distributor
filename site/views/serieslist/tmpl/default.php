...
<?php endif; ?>
<?php if ($this->items): ?>
	<?php if ($this->params->get('list_series_display') == 1) : ?>
		<?php echo $this->loadTemplate('series-table'); ?>
	<?php elseif ($this->params->get('list_series_display') == 2) : ?>
		<?php echo $this->loadTemplate('series-grid'); ?>
	<?php else: ?>
		<?php echo $this->loadTemplate('series-list'); ?>
	<?php endif; ?>
<?php else: ?>
	<div class="uk-alert uk-alert-warning" data-uk-alert>
		<a href="" class="uk-alert-close uk-close"></a>
		<p><?php echo JText::_('COM_SERMONDISTRIBUTOR_NO_SERIES_WERE_FOUND'); ?></p>
	</div>
<?php endif; ?>
