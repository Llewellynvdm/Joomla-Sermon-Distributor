...
class SermondistributorViewCategory extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		// [3781] load the meta description
		...
		// [3790] load the key words if set
