...
<?php endif; ?>
<?php if ($this->items): ?>
	<?php if ($this->params->get('categories_display') == 1) : ?>
		<?php echo $this->loadTemplate('categories-table'); ?>
	<?php elseif ($this->params->get('categories_display') == 2) : ?>
		<?php echo $this->loadTemplate('categories-grid'); ?>
	<?php else: ?>
		<?php echo $this->loadTemplate('categories-list'); ?>
	<?php endif; ?>
<?php else: ?>
	<div class="uk-alert uk-alert-warning" data-uk-alert>
		<a href="" class="uk-alert-close uk-close"></a>
		<p><?php echo JText::_('COM_SERMONDISTRIBUTOR_NO_CATEGORIES_WERE_FOUND'); ?></p>
	</div>
<?php endif; ?>
