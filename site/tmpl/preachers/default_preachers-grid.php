...
<ul id="preachers-sort-menu" class="uk-subnav">
	<li data-uk-sort="preacher"><a href=""><?php echo Text::_('COM_SERMONDISTRIBUTOR_NAME_ASC'); ?></a></li>
	<li data-uk-sort="preacher:desc"><a href=""><?php echo Text::_('COM_SERMONDISTRIBUTOR_NAME_DESC'); ?></a></li>
...
<div data-uk-check-display class="uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-4" data-uk-grid="{controls: '#preachers-sort-menu',gutter: 15}">
	<?php foreach ($this->items as $item): ?>
		<div data-preacher="<?php echo $this->escape($item->name); ?>" data-hits="<?php echo (int) $item->hits; ?>" data-sermons="<?php echo count($item->idPreacherSermonB); ?>"><?php $item->params = $this->params; $item->desc = $this->escape($item->description, true, 65); echo LayoutHelper::render('preacherspanel', $item); ?></div>
	<?php endforeach; ?>
</div>
