...
/------------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Help_documentTable.php
 ...
 * @since  1.6
 */
class Help_documentTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_sermondistributor.help_document';
		...
		parent::__construct('#__sermondistributor_help_document', 'id', $db, $dispatcher);
	}
