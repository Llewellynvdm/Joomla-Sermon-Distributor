...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.addTab', 'local_listingTab', 'publishing', Text::_('COM_SERMONDISTRIBUTOR_LOCAL_LISTING_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'local_listingTab', 'permissions', Text::_('COM_SERMONDISTRIBUTOR_LOCAL_LISTING_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
