...
class SermondistributorViewExternal_sources extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_SERMONDISTRIBUTOR_EXTERNAL_SOURCES'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_sermondistributor/assets/css/external_sources.css");
	}
