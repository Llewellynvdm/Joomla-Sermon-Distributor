...
class SermondistributorViewSeries_list extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_SERMONDISTRIBUTOR_SERIES_LIST'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_sermondistributor/assets/css/series_list.css", (SermondistributorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
