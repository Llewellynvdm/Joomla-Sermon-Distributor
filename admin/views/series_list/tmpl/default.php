...
if ($this->saveOrder)
{
	...
	Html::_('sortablelist.sortable', 'seriesList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo Route::_('index.php?option=com_sermondistributor&view=series_list'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_SERMONDISTRIBUTOR_SERIES_LIST_BATCH_OPTIONS'),
