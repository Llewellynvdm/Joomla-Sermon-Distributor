...
class SermondistributorViewPreachers extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_SERMONDISTRIBUTOR_PREACHERS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_sermondistributor/assets/css/preachers.css", (SermondistributorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
