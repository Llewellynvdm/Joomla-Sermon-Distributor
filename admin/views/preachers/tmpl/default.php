...
if ($this->saveOrder)
{
	...
	Html::_('sortablelist.sortable', 'preacherList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo Route::_('index.php?option=com_sermondistributor&view=preachers'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_SERMONDISTRIBUTOR_PREACHERS_BATCH_OPTIONS'),
