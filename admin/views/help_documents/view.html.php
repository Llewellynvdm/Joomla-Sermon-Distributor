...
class SermondistributorViewHelp_documents extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		// [Interpretation 8677] Set Type Selection
		$this->typeOptions = $this->getTheTypeSelections();
		if ($this->typeOptions)
		{
			// [Interpretation 8681] Type Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8690] Type Batch Selection
				JHtmlBatch_::addListSelection(
		...
		// [Interpretation 8677] Set Location Selection
		$this->locationOptions = $this->getTheLocationSelections();
		if ($this->locationOptions)
		{
			// [Interpretation 8681] Location Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8690] Location Batch Selection
				JHtmlBatch_::addListSelection(
		...
		{
			// [Interpretation 8681] Admin View Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8690] Admin View Batch Selection
				JHtmlBatch_::addListSelection(
		...
		{
			// [Interpretation 8681] Site View Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8690] Site View Batch Selection
				JHtmlBatch_::addListSelection(
	...
	protected function getTheTypeSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8580] Translate the type selection
				$text = $model->selectionTranslation($type,'type');
				// [Interpretation 8582] Now add the type and its text to the options array
	...
	protected function getTheLocationSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8580] Translate the location selection
				$text = $model->selectionTranslation($location,'location');
				// [Interpretation 8582] Now add the location and its text to the options array
	...
	protected function getTheAdmin_viewSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8587] Now add the admin_view and its text to the options array
	...
	protected function getTheSite_viewSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8587] Now add the site_view and its text to the options array
