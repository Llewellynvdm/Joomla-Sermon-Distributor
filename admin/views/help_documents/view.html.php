...
class SermondistributorViewHelp_documents extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		// [Interpretation 8933] Set Type Selection
		$this->typeOptions = $this->getTheTypeSelections();
		if ($this->typeOptions)
		{
			// [Interpretation 8937] Type Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8946] Type Batch Selection
				JHtmlBatch_::addListSelection(
		...
		// [Interpretation 8933] Set Location Selection
		$this->locationOptions = $this->getTheLocationSelections();
		if ($this->locationOptions)
		{
			// [Interpretation 8937] Location Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8946] Location Batch Selection
				JHtmlBatch_::addListSelection(
		...
		// [Interpretation 8933] Set Admin View Selection
		$this->admin_viewOptions = $this->getTheAdmin_viewSelections();
		if ($this->admin_viewOptions)
		{
			// [Interpretation 8937] Admin View Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8946] Admin View Batch Selection
				JHtmlBatch_::addListSelection(
		...
		// [Interpretation 8933] Set Site View Selection
		$this->site_viewOptions = $this->getTheSite_viewSelections();
		if ($this->site_viewOptions)
		{
			// [Interpretation 8937] Site View Filter
			JHtmlSidebar::addFilter(
			...
			if ($this->canBatch && $this->canCreate && $this->canEdit)
			{
				// [Interpretation 8946] Site View Batch Selection
				JHtmlBatch_::addListSelection(
	...
	protected function getTheTypeSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8831] Translate the type selection
				$text = $model->selectionTranslation($type,'type');
				// [Interpretation 8833] Now add the type and its text to the options array
	...
	protected function getTheLocationSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8831] Translate the location selection
				$text = $model->selectionTranslation($location,'location');
				// [Interpretation 8833] Now add the location and its text to the options array
	...
	protected function getTheAdmin_viewSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8843] Now add the admin_view and its text to the options array
	...
	protected function getTheSite_viewSelections()
	{
		...
		if ($results)
		{
			...
			{
				// [Interpretation 8843] Now add the site_view and its text to the options array
