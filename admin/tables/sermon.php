 ...
 * Sermons Table class
 */
class SermondistributorTableSermon extends JTable
{
	/**
	...
	function __construct(&$db) 
	{
		...
		// [Interpretation 3479] Adding Tag Options
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SERMONDISTRIBUTOR_SERMON_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
