 ...
 */
class SermondistributorTableLocal_listing extends Table
{
	/**
	...
	function __construct(&$db)
	{
		...
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_sermondistributor.local_listing'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('local_listing', 'SermondistributorTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_sermondistributor.local_listing.'.(int) $this->$k;
	}
