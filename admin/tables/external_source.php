 ...
 */
class SermondistributorTableExternal_source extends Table
{
	/**
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('external_source', 'SermondistributorTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_sermondistributor.external_source.'.(int) $this->$k;
	}
