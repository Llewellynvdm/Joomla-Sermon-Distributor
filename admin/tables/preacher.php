 ...
 */
class SermondistributorTablePreacher extends Table
{
	/**
	...
	function __construct(&$db)
	{
		...
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_sermondistributor.preacher'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('preacher', 'SermondistributorTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_sermondistributor.preacher.'.(int) $this->$k;
	}
