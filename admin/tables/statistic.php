 ...
 */
class SermondistributorTableStatistic extends Table
{
	/**
	...
	function __construct(&$db)
	{
		...
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_sermondistributor.statistic'));
	}
	...
	{
		$k = $this->_tbl_key;
		return 'com_sermondistributor.statistic.'.(int) $this->$k;
	}
