...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'external_sourceTab', ['active' => 'details', 'recall' => true]); ?>

	<?php echo Html::_('uitab.addTab', 'external_sourceTab', 'details', Text::_('COM_SERMONDISTRIBUTOR_EXTERNAL_SOURCE_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'external_sourceTab', 'build_option', Text::_('COM_SERMONDISTRIBUTOR_EXTERNAL_SOURCE_BUILD_OPTION', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'external_sourceTab', 'publishing', Text::_('COM_SERMONDISTRIBUTOR_EXTERNAL_SOURCE_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'external_sourceTab', 'permissions', Text::_('COM_SERMONDISTRIBUTOR_EXTERNAL_SOURCE_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
