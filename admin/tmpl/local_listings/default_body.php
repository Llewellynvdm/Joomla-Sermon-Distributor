...
$edit = "index.php?option=com_sermondistributor&view=local_listings&task=local_listing.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = SermondistributorHelper::getActions('local_listing',$item,'local_listings');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="nowrap">
			<div class="name">
				<?php if ($canDo->get('local_listing.edit')): ?>
					...
					<?php if ($item->checked_out): ?>
						<?php echo Html::_('jgrid.checkedout', $i, $userChkOut->name, $item->checked_out_time, 'local_listings.', $canCheckin); ?>
					<?php endif; ?>
				<?php else: ?>
		...
		<?php if ($canDo->get('local_listing.edit.state')) : ?>
				<?php if ($item->checked_out) : ?>
					<?php if ($canCheckin) : ?>
						<?php echo Html::_('jgrid.published', $item->published, $i, 'local_listings.', true, 'cb'); ?>
					<?php else: ?>
						<?php echo Html::_('jgrid.published', $item->published, $i, 'local_listings.', false, 'cb'); ?>
					<?php endif; ?>
				<?php else: ?>
					<?php echo Html::_('jgrid.published', $item->published, $i, 'local_listings.', true, 'cb'); ?>
				<?php endif; ?>
