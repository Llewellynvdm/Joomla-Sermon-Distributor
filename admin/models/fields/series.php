...
class JFormFieldSeries extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($setButton === 'true')
		{
			...
			// [Interpretation 7184] only add if user allowed to create series
			...
			// [Interpretation 7207] only add if user allowed to edit series
			...
			// [Interpretation 7248] check if button was created for series field.
