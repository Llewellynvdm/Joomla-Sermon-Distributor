...
class JFormFieldArticles extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($setButton === 'true')
		{
			...
			// [Interpretation 7184] only add if user allowed to create article
			...
			// [Interpretation 7207] only add if user allowed to edit article
			...
			// [Interpretation 7248] check if button was created for article field.
